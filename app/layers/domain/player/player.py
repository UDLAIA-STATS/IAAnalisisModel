...
class Player(IPlayer):
    ...
    def __init__(self,
                 id: int,
                 bbox: List[float],
                 position_2d: Tuple[float,
                                    float],
                 position_adjusted_2d: Tuple[float,
                                             float],
                 position_transformed_2d: Optional[List[float]] = None,
                 speed: Optional[float] = None,
                 distance: Optional[float] = None,
                 position_3d: Optional[List[float]] = None,
                 position_adjusted_3d: Optional[List[float]] = None,
                 position_transformed_3d: Optional[List[float]] = None,
                 team: str = '',
                 team_color: Optional[List[float]] = None,
                 has_ball: bool = False,
                 timestamp: float = 0.0):
        self.id = id
        self.bbox = bbox
